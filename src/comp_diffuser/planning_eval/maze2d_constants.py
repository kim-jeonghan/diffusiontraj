...
## LH: Long horizon
Maze2D_Large_Bottom_Row_ours_LH = np.array(
    [[1, 1], [2, 1], [3, 1], [4, 1], [5, 1], [7, 1]], dtype=np.float32
)

Maze2D_Large_Top_Row_ours_LH = np.array(
    [[1, 10], [2, 10], [3, 10], [4, 10], [5, 10], [7, 10]], dtype=np.float32
)
