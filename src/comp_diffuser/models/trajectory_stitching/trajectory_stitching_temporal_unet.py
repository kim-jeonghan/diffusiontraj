...
from comp_diffuser.models.conditional_diffusion.residual_temporal_block import ResidualTemporalBlock
from comp_diffuser.models.conditional_diffusion.trajectory_time_encoder import TrajectoryTimeEncoder
...
class TrajectoryStitchingTemporalUNet(nn.Module):
    ...
    def __init__(
        ...
        utils.print_color(f'[ models/TrajectoryStitchingTemporalUNet ] Channel dimensions: {in_out}', c='c')
