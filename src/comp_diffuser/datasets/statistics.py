...
MAZE_Large_Act_Min = np.array([-1.0, -1.0], dtype=np.float32)
MAZE_Large_Act_Max = np.array([1.0, 1.0], dtype=np.float32)
...
Ben_maze_large_Act_Min = np.array([-1.0, -1.0], dtype=np.float32)
Ben_maze_large_Act_Max = np.array([1.0, 1.0], dtype=np.float32)
...
MAZE_Large_ObsVel_Min = np.array(
    [0.39643136, 0.44179875, -5.2262554, -5.2262554], dtype=np.float32
)
MAZE_Large_ObsVel_Max = np.array(
    [7.2163844, 10.219488, 5.2262554, 5.2262554], dtype=np.float32
)
