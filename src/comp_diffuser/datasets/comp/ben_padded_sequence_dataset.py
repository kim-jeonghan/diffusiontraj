...
from comp_diffuser.datasets.comp.ben_padded_replay_buffer import BenPaddedReplayBuffer
from comp_diffuser.datasets.comp.compositional_sequence_dataset import SequenceBatch
...
class BenPaddedSequenceDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, env='hopper-medium-replay', horizon=64,
        ...
        fields = BenPaddedReplayBuffer(max_n_episodes, max_path_length, termination_penalty, replBuf_config=replBuf_config)
    ...
    def __getitem__(self, idx, eps=1e-4):
        ...
        batch = SequenceBatch(obs_trajs, act_trajs, conditions)
        return batch
