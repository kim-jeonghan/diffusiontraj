...
from .ben_padded_replay_buffer import BenPaddedReplayBuffer
from .compositional_data_utils import comp_sequence_dataset
from .compositional_sequence_dataset import SequenceBatch
    ...
    def __getitem__(self, idx, eps=1e-4):
        ...
        if self.pad_type == "pad_sample_v1" and pad_len > 0:
            ...
            if random.random() < self.padsam_first_prob:  ## 0.5
                ...
                act_trajs = np.concatenate(
                    [
                        np.zeros_like(act_trajs[0:1]),
                    ]
                    * pad_len
                    + [
                        act_trajs,
